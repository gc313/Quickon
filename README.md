...
Quickon 是一个 Unity 插件，用于对预制件进行批量拍摄并生成 PNG 图片。它集成了自动拍照和手动拍照功能。本插件采用了官方的 Cinemachine 包和 ShaderGraph 包，适用于 Unity 编辑器版本 6000.0.25 及以上。
...
在 Unity 编辑器中，选择 `Window -> Quickon` 打开 Quickon 窗口。
