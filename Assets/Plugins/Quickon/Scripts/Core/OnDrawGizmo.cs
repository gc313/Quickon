...
public class OnDrawGizmo : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        ...
        // 计算边界点
        Vector3 bottomLeft = m_Camera.ViewportToWorldPoint(new Vector3(leftMargin, 0, nearClipPlane));
        Vector3 topRight = m_Camera.ViewportToWorldPoint(new Vector3(rightMargin, 1, nearClipPlane));
        Vector3 bottomRight = m_Camera.ViewportToWorldPoint(new Vector3(rightMargin, 0, nearClipPlane));
